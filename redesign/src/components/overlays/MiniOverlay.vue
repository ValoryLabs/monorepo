...
<template>
  ...
  >
    <div class="flex flex-row items-center justify-center gap-2">
      ...
      <div class="font-bold text-[var(--primary-text-color)]">2000 RR</div>
    </div>
    <div v-if="!disabledWinLose" class="flex flex-row items-center gap-2">
      <span class="flex flex-row items-center gap-1 font-bold text-[var(--win-color)]">
        <ArrowUp />
        2
      </span>
      <span class="flex flex-row items-center gap-1 font-bold text-[var(--lose-color)]">
        <ArrowDown />
        0
      </span>
      <span class="flex flex-row items-center gap-1 font-bold text-[var(--win-color)]">
