...
export const tabsTriggerVariants = cva(
  "inline-flex h-full cursor-pointer flex-1 items-center rounded text-sm whitespace-nowrap shadow-inner  transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
