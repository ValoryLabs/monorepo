...
<template>
  <figure
    ...
    class="relative w-64 cursor-pointer overflow-hidden rounded-xl border border-transparent bg-[#0F0F0F] p-4 transition-colors hover:border-white/10 hover:bg-white/10"
  >
    <div class="flex flex-row items-center gap-2">
      <div class="relative h-fit">
        <img :src="img" class="rounded-full" width="32" height="32" alt="" fetchpriority="low" />
        <span v-if="live" class="absolute top-0 right-0 rounded-xl bg-green-500 p-1"></span>
      </div>
