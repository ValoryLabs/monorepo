...
<template>
  <button
    ...
    class="inline-flex h-9 cursor-pointer items-center justify-between rounded-md border border-white/10 p-1 font-mono text-sm transition-all duration-200 hover:border-white/15 hover:bg-white/5"
    @click="updateChecked()"
