...
import ProfileHeader from '@/components/configuration-page/settings/Profile/ProfileHeader.vue'
import ProfileRoot from '@/components/configuration-page/settings/Profile/ProfileRoot.vue'
import ProfileSection from '@/components/configuration-page/settings/Profile/ProfileSection.vue'
